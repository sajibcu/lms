...
class Reports extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/reports/list',$data,true);
	...
	public function requested_reports()
	{
        ...
        $data['currency'] =  'BDT';
        $data['currency_position'] =  'left';
		$data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/reports/requested_reports',$data,true);
		$this->load->view('dashboard_laboratorist/main_wrapper',$data);
    } 
    ...
    public function view($rid){
        ...
        $data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/reports/view',$data,true);
        $this->load->view('dashboard_laboratorist/main_wrapper',$data);
    }
    ...
    public function entry_data($rid){
        ...
        if ($this->form_validation->run() === true) {
            ...
            redirect('dashboard_laboratorist/lab_manager/reports/entry_data/'.$rid);
        }else{
            ...
            $data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/reports/entry_data',$data,true);
            $this->load->view('dashboard_laboratorist/main_wrapper',$data);
        }
    }
    ...
    { 
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('dashboard_laboratorist/lab_manager/template/index');
            } else {
                $data['title'] = 'Add Report Template';
                $data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/templates/create',$data,true);
                $this->load->view('dashboard_laboratorist/main_wrapper',$data);
            } 
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('dashboard_laboratorist/lab_manager/template/create/'.$postData['id']);
            } else {
    ...
    public function delete($id = null) 
    {
        ...
        redirect('dashboard_laboratorist/lab_manager/reports');
    }	
}
