...
class Invoice extends CI_Controller {
	...
	{  
		...
		if ($this->form_validation->run() === true) {
			...
			if($this->input->post('temp_patient')  == '1')
			{
				$paientData = array(
					'patient_id' 	=> $this->input->post('patient_id', true),
					'firstname' 	=> $this->input->post('patient_name', true),
					'address' 		=> $this->input->post('patient_address', true)
				);
				$this->db->insert("patient",$paientData);
			}
