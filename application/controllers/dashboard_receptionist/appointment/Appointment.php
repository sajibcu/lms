...
class Appointment extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'dashboard_receptionist/appointment/appointment_model',
    ...
    { 
        ...
        $data['content'] = $this->load->view('dashboard_receptionist/appointment/appointment',$data,true);
    ...
    public function create()
    {
        ...
        $data['appointment'] = (object)$postData = [
            'appointment_id' => date('ymd').random_string('numeric', 6),
            'patient_id'     => $this->input->post('patient_id',true), 
            'department_id'  => $this->input->post('department_id',true), 
            'doctor_id'      => $this->input->post('doctor_id',true), 
            'ticket_fee'     => $this->input->post('ticket_fee',true) ? $this->input->post('ticket_fee',true) : 0,
        ...
        if ($this->form_validation->run() === true && $check_patient_id->status === true && $check_appointment_exists === true) {
            ...
            redirect('dashboard_receptionist/appointment/appointment/view/'.$postData['appointment_id']);

        } else {
            $data['department_list'] = $this->department_model->department_list(); 
            $data['content'] = $this->load->view('dashboard_receptionist/appointment/appointment_form',$data,true);
            $this->load->view('dashboard_receptionist/main_wrapper',$data);
        } 
    }
      ...
      {  
        ...
        $data['oparator'] =  $this->session->userdata('fullname');
