...
class Bed_assign extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_receptionist/bed_manager/bedAssign_view',$data,true);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() === true && $this->check_bed(true) === true) { 
            ...
            redirect('dashboard_receptionist/bed_manager/bed_assign/create');

        } else {
            $data['bed_list'] = $this->bed_model->bed_list();
            $data['content'] = $this->load->view('dashboard_receptionist/bed_manager/bedAssign_form',$data,true);
            $this->load->view('dashboard_receptionist/main_wrapper',$data);
        } 
    }
    public function edit($serial = null) 
    {
        ...
        if ($this->form_validation->run() === true && $this->check_bed(true) === true) { 
            ...
            redirect('dashboard_receptionist/bed_manager/bed_assign/edit/'.$newSerial);

        } else {
            $data['bed']      = $this->bed_assign_model->read_by_serial($serial);
            $data['bed_list'] = $this->bed_model->bed_list();
            $data['content']  = $this->load->view('dashboard_receptionist/bed_manager/bedAssign_edit',$data,true);
            $this->load->view('dashboard_receptionist/main_wrapper',$data);
        }
    }
    ...
    public function delete($serial = null) 
    {
        ...
        redirect('dashboard_receptionist/bed_manager/bed_assign');
    }
