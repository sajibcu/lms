...
class Report extends CI_Controller {
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_receptionist/bed_manager/report',$data,true);
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_receptionist/bed_manager/report_details',$data,true);
		$this->load->view('dashboard_receptionist/main_wrapper',$data);
	} 
