...
class Unit extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('lab_manager/templates/unit_view',$data,true);
    ...
    { 
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('lab_manager/templates/unit/form');
            } else {
                $data['title'] = 'Add Type';
                $data['content'] = $this->load->view('lab_manager/templates/unit_form',$data,true);
                $this->load->view('layout/main_wrapper',$data);
            } 
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('lab_manager/templates/unit/form/'.$postData['id']);
            } else {
    ...
    public function delete($id = null) 
    {
        ...
        redirect('lab_manager/templates/unit');
    }
