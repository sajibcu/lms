...
class Category extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('pharmacy_manager/medicine/category_view',$data,true);
	...
	{  
		...
		$data['content'] = $this->load->view('pharmacy_manager/medicine/details',$data,true);
		$this->load->view('layout/main_wrapper',$data);
	} 
    ...
    { 
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('pharmacy_manager/medicine/category/form');
            } else {
                $data['title'] = display('add_medicine_category');
                $data['content'] = $this->load->view('pharmacy_manager/medicine/category_form',$data,true);
                $this->load->view('layout/main_wrapper',$data);
            } 
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('pharmacy_manager/medicine//category/form/'.$postData['id']);
            } else {
    ...
    public function delete($id = null) 
    {
        ...
        redirect('pharmacy_manager/medicine/category');
    }
