...
class Admission extends CI_Controller {
	...
	{ 
        ...
        #pagination ends
        #    
		$data['content'] = $this->load->view('dashboard_accountant/billing/admission/list',$data,true);
	...
	{ 
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('dashboard_accountant/billing/admission/form/');
		} else {  
			...
			$data['content'] = $this->load->view('dashboard_accountant/billing/admission/form',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
	...
	{ 
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('dashboard_accountant/billing/admission/form/'.$admission_id);
			...
			$data['package_list'] = $this->admission_model->package_list();
			$data['insurance_list'] = $this->admission_model->insurance_list();
			$data['content'] = $this->load->view('dashboard_accountant/billing/admission/edit',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
    ...
    public function delete($id = null) 
    {
		...
		redirect('dashboard_accountant/billing/admission/index');
    }
