...
class Package extends CI_Controller {
	...
	{ 
        ...
        #pagination ends
        #    
		$data['content'] = $this->load->view('dashboard_accountant/billing/package/list',$data,true);
	...
	public function form()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('dashboard_accountant/billing/package/form/');

		} else {  
			$data['service_list'] = $this->service_model->readList();
			$data['content'] = $this->load->view('dashboard_accountant/billing/package/form',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
	...
	public function edit($id = null)
	{
		...
		if ($this->form_validation->run() === true) {
			...
			$data['content'] = $this->load->view('dashboard_accountant/billing/package/edit',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
	...
	public function view($id = null)
	{
		...
		$data['package'] = $this->package_model->read_by_id($id);
		$data['content'] = $this->load->view('dashboard_accountant/billing/package/view',$data,true);
		$this->load->view('dashboard_accountant/main_wrapper',$data);
	}
    ...
    public function delete($id = null) 
    {
		...
		redirect('dashboard_accountant/billing/package/index');
    }
