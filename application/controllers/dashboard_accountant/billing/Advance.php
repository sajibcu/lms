...
class advance extends CI_Controller {
	...
	{ 
        ...
        #pagination ends
        #    
		$data['content'] = $this->load->view('dashboard_accountant/billing/advance/list',$data,true);
	...
	public function form($id = null)
	{
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($id)) 
			{
				...
				redirect('dashboard_accountant/billing/advance/form/');
			}
			else 
			{
				...
				redirect('dashboard_accountant/billing/advance/form/'.$id);
			}
			...
			$data['content'] = $this->load->view('dashboard_accountant/billing/advance/form',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
    ...
    public function delete($id = null) 
    {
		...
		redirect('dashboard_accountant/billing/advance/index');
    }
