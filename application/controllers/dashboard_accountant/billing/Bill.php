...
class Bill extends CI_Controller {
	...
	{ 
        ...
        #pagination ends
        #    
		$data['content'] = $this->load->view('dashboard_accountant/billing/bill/list',$data,true);
	...
	public function form()
	{
		...
		if ($this->form_validation->run()) {
			...
			$data['content'] = $this->load->view('dashboard_accountant/billing/bill/form',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
	...
	public function edit($bill_id = null)
	{
		...
		if ($this->form_validation->run()) 
		{
			...
			redirect('dashboard_accountant/billing/bill/edit/'.$postData['bill_id']);
		} else {   
			...
			$data['advance'] = $this->bill_model->advance_payment($bill_id); 
			$data['service_list'] = $this->service_model->readList(); 
			$data['content'] = $this->load->view('dashboard_accountant/billing/bill/edit',$data,true);
			$this->load->view('dashboard_accountant/main_wrapper',$data);
		} 
	}
    ...
    public function delete($id = null) 
    {
		...
		redirect('dashboard_accountant/billing/bill/index');
    }
