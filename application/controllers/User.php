...
class User extends CI_Controller {
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('fee1', 'Ticket Fee (1<sup>st</sup> Time)' ,'required');
		$this->form_validation->set_rules('fee2', 'Ticket Fee (2<sup>nd</sup> Time)' ,'required');
		...
		if ($this->input->post('user_id',true) == null) {
			$data['doctor'] = (object)$postData = [
				...
				'fee1'  	   => $this->input->post('fee1',true) ? $this->input->post('fee1',true) : 0,
				'fee2'  	   => $this->input->post('fee2',true) ? $this->input->post('fee2',true) : 0,
