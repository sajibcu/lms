...
class Bill_model extends CI_Model {
	...
	{ 
		return $this->db->select("
				...
				IF(ba.discharge_date=ba.admission_date,'1',DATEDIFF(ba.discharge_date, ba.admission_date)) as total_days,
	...
	{
		return $this->db->select('title, description, email, phone,logo,mobile,website')
			->from('setting')
			->get()
			->row();
	}
