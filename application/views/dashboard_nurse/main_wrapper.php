                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        <li class="<?php echo (($this->uri->segment(2) == 'home') ? "active" : null) ?>">
                            <a href="<?php echo base_url('dashboard_nurse/home') ?>"><i class="fa ti-home"></i> <span><?php echo display('dashboard') ?></span></a>
                        </li> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "sms") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_nurse/sms/sms/new_sms") ?>"> <?php echo display('new_sms') ?> </a></li> 
                                <li><a href="<?php echo base_url("dashboard_nurse/sms/sms/sms_list") ?>"> <?php echo display('sms_list') ?> </a></li> 
                            </ul>
                        </li> 
