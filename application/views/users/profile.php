                ...
                <div class="row">
                    ...
                    <div class="col-sm-8"> 
                        <dl class="dl-horizontal">
                            <dt><?php echo display('user_type') ?></dt><dd><?php echo ucfirst($profile->user_role_name) ?></dd> 
                             <?php
                                if($profile->father_or_spouse !='')
                                {
                                    echo "<dt>Father/Spouse Name</dt>"."<dd>".$profile->father_or_spouse."</dd>";
                                }
                            ?>
                            ...
                            <?php
                                if($profile->father_or_spouse !='')
                                {
                                    echo "<dt>Religion</dt>"."<dd>".$profile->religion."</dd>";
                                }
                                if($profile->employement_type !='')
                                {
                                    echo "<dt>".display('employement_type')."</dt>"."<dd>".$profile->employement_type."</dd>";
                                }
                            ?>
