                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-left" style="display: inline-block;margin-left: 5px;">
                            ...
                            <div>Purchase ID: <?= $item->purchase_id ?></div>
                            <div class="m-b-15">Billing Date: <?= date('d - M - Y', strtotime($item->purchase_id)) ?></div>
                            <span class="label label-success-outline m-r-15">Billing To</span>

                            <?php if($manufacturer): ?>
                            <address style="margin-top:10px;width: 200px">
                                <strong><?= $manufacturer->manufacturer_name ?> </strong><br>
                                <?= $manufacturer->address ?><br>
                                <abbr><b>Mobile:</b> <?= $manufacturer->mobile ?></abbr>
                            </address>
                            <?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive m-b-20">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php $subtotal += abs($subitem->total_amount) ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?= format_price( abs($subitem->total_amount), $currency, $currency_position) ?></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
                            <tfoot>
                                ...
                                <td style="border: 0px"></td>
                                <td style="border: 0px"></td>
                                <td align="center" style="border: 0px"><b><?= format_price( abs($subtotal), $currency, $currency_position) ?></b></td>
                            </tr></tfoot>
                        </table>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4" style="display: inline-block;">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th style="border-top: 0; border-bottom: 0;">Deduction : </th>
                                        <td style="border-top: 0; border-bottom: 0;"><?= format_price( -$ritem->total_deduct, $currency, $currency_position) ?> </td>
                                    </tr>
                                                                                <tr>
