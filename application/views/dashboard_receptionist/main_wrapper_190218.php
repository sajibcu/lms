                    ...
                    <ul class="sidebar-menu"> 
                       ...
                       <li class="treeview <?php echo (($this->uri->segment(2) == "billing") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/bill/form") ?>"><?php echo display('add_bill') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/bill") ?>"><?php echo display('bill_list') ?></a></li>  
                            </ul>
                        </li>
                       <!--  End of billing --> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "bed_manager") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_receptionist/bed_manager/report") ?>"><?php echo display('report') ?></a></li> 
                            </ul>
                        </li>
                        <!-- End of bed manager -->
