            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_receptionist/billing/advance/form/'.$advance->id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="admission_id"  type="text" class="form-control" onblur="getPatientId(this)" id="admission_id" placeholder="<?php echo display('admission_id') ?>" value="<?php echo $advance->admission_id ?>">
                                </div>
                            </div>
