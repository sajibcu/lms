    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_receptionist/billing/bill/form") ?>"> <i class="fa fa-plus"></i>  <?php echo "Add Discharge Bill" ?> </a>  
                </div>
            </div>
                        ...
                        <?php if (!empty($bills)) { ?>
                            ...
                            <?php foreach ($bills as $bill) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_receptionist/billing/bill/view/$bill->bill_id") ?>" class="btn btn-xs  btn-primary"><i class="fa fa-eye"></i></a> 
                                        <a style="display: none;" href="<?php echo base_url("dashboard_receptionist/billing/bill/edit/$bill->bill_id") ?>" class="btn btn-xs  btn-warning"><i class="fa fa-edit"></i></a> 
                                        <a style="display: none;" href="<?php echo base_url("dashboard_receptionist/billing/bill/delete/$bill->bill_id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
