                ...
                <div class="row">
                    ...
                    <div class="col-sm-9"> 
                        <dl class="dl-horizontal">
                            ...
                            <dt>Father/Spouse Name</dt><dd><?php echo $profile->fatherOrSpouse ?></dd> 
                            <dt>Religion</dt><dd><?php echo $profile->religion ?></dd> 
                            <dt>Occupation</dt><dd><?php echo $profile->Occupation ?></dd> 
