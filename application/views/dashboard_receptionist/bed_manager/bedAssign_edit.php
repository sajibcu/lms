    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_receptionist/bed_manager/bed_assign") ?>"> <i class="fa fa-list"></i>  <?php echo display('bed_assign_list') ?> </a> 
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_receptionist/bed_manager/bed_assign/edit/'.$bed->serial,'class="form-inner"') ?>
...
$(document).ready(function() {
    ...
    $('#patient_id').keyup(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_receptionist/bed_manager/bed_assign/check_patient/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
    ...
    dateChange.change(function(){ 
        $.ajax({
            url  : '<?= base_url('dashboard_receptionist/bed_manager/bed_assign/check_bed/') ?>',
            type : 'POST',
            dataType : 'JSON',
            data : {
                '<?= $this->security->get_csrf_token_name(); ?>' : '<?= $this->security->get_csrf_hash(); ?>',
