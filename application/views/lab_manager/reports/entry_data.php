...
<div class="row">
    <div class="col-sm-12">
        <div class="columns">
            <a href="<?= site_url('lab_manager/reports/view/'.$item->id) ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> View Report  </a>
        </div>
    </div>
</div>
<?php endif ?>
    ...
    <div class="col-sm-12">
        <div class="panel panel-bd">
            <div id="printableArea">
                <?php echo form_open('lab_manager/reports/entry_data/'.$item->id,'class="form-inner"') ?>
