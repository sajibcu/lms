...
<div class="row">
    <div class="col-sm-12">
        <div class="columns">
            <a href="<?php echo base_url("lab_manager/template/index") ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Manage Templates  </a>
        </div>
    </div>
</div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <?php echo form_open('lab_manager/template/create/'.$item->id,'class="form-inner"') ?>
