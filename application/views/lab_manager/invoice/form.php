...
<div class="row">
    <div class="col-sm-12">
        <div class="columns">
            <a href="<?php echo base_url("lab_manager/invoice") ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Manage Invoice  </a>
        </div>
    </div>
</div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <?php echo form_open('lab_manager/invoice/form/'.$item->id,'class="form-inner"') ?>
                            ...
                            <div class="row">
                                <div class="col-sm-8" id="payment_from_1">
                                    <div class="form-group row">
                                        <label for="customer_name" class="col-sm-3 col-form-label">Patient Name <i class="text-danger">*</i></label>
                                        <div class="col-sm-6">
                                            <input type="text" size="100"  name="customer_name" value="<?= $item->customer_name ?>" class="customerSelection form-control" placeholder='Patient Name' id="customer_name" tabindex="1" />
                                            <input id="SchoolHiddenId" class="customer_hidden_value abc" type="hidden" name="customer_id" value="<?= $item->customer_id ?>">
                                        </div>
                                        <?php if(true): ?>
                                        <div  class=" col-sm-3">
                                            <input id="myRadioButton_1" type="button" onClick="active_customer('payment_from_1')" id="myRadioButton_1" class="btn btn-success checkbox_account ac" name="customer_confirm" checked="checked" value="New Patient" tabindex="2">
                                        </div>
                                        <?php endif ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-8" id="payment_from_2">
                                    <div class="form-group row">
                                        ...
                                        <div  class="col-sm-3">
                                            <input  onClick="active_customer('payment_from_2')" type="button" id="myRadioButton_2" class="checkbox_account btn btn-success" name="customer_confirm_others" value="Old Patient">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="doctor_id" class="col-sm-4 col-form-label">Reference</label>
                                        <div class="col-sm-8">
                                            <?php echo form_dropdown('doctor_id', $doctors, $item->doctor_id, 'id="doctor_id" class="form-control"') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive" style="margin-top: 10px">
                                <table id="fixTable" class="table table-bordered table-hover" id="normalinvoice">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="addinvoiceItem">
                                        ...
                                        <tr>
                                            <td style="width: 220px">
                                                <input type="text" name="product_name[]" onkeyup="invoice_productList(<?= $index + 1 ?>);" class="form-control labReportSelection" placeholder='Test Name' required="" id="product_name<?= $index + 1 ?>" tabindex="7" value="<?= $subitem->product_name ?>">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="text-align:right;" colspan="3"><b>Total Tax:</b></td>
                                            <td class="text-right">
                                        ...
                                        <tr id="change_m"><td style="text-align:right;" colspan="4" id="ch_l"><b>Change:</b></td>
                                            <td class="text-right">
...
<script type="text/javascript">
    function product_stock(sl) {
        ...
        var expire_date    = 'expire_date_'+sl;
            $.ajax({
            type: "POST",
            url: base_url+"lab_manager/medicine/medicine/retrieve_product_batchid",
            data: dataString,
            cache: false,
