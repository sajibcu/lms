                        ...
                        <?php if (!empty($patients)) { ?>
                            ...
                            <?php foreach ($patients as $patient) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        <?php
                                        if($patient->picture == '' && $patient->sex == 'Male')
                                        {
                                            echo '<img src="'.base_url().'assets/images/patient/male.png'.'"  width="65" height="50"/>';

                                        }else if($patient->picture == '' && $patient->sex == 'Female')
                                        {
                                            echo '<img src="'.base_url().'assets/images/patient/female.png'.'"  width="65" height="50"/>';

                                        }
                                        else{
                                            echo '<img src="'.base_url($patient->picture).'"  width="65" height="50"/>';
                                        }?>
                                        <!-- <img src="<?php echo $patient->picture; ?>"  width="65" height="50"/> -->
                                    </td>
