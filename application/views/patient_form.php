            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <?php if($this->session->userdata('user_role')==7)
                        echo '<a class="btn btn-primary" href="'.base_url("dashboard_receptionist/patient/patient").'"> <i class="fa fa-list"></i>'.display('patient_list').'</a>';  
                        else {
                        echo '<a class="btn btn-primary" href="'.base_url("patient").'"> <i class="fa fa-list"></i>'.display('patient_list').'</a>';  
                    }?>
                </div>
            </div> 
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('patient/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="fatherOrSpouse" type="text" class="form-control" id="fatherOrSpouse" placeholder="Father/Spouse Name" value="<?php echo $patient->fatherOrSpouse ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="religion" type="text" class="form-control" id="religion" placeholder="Religion" value="<?php echo $patient->religion ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Occupation" class="col-xs-3 col-form-label">Occupation</label>
                                <div class="col-xs-9">
                                    <input name="Occupation" type="text" class="form-control" id="Occupation" placeholder="Occupation" value="<?php echo $patient->Occupation ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="date_of_birth" class="datepicker form-control" type="text" placeholder="<?php echo display('date_of_birth') ?>" id="date_of_birth" onchange = "calculateAge()" value="<?php echo $patient->date_of_birth ?>">
                                </div>
                            </div>
                             <!-- age of the patient -->
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="age" class="form-control"  type="text" placeholder="<?php echo display('age') ?>" id="age" onblur="calculatebirthdate()" value="<?php echo $patient->age ?>">
                                </div>
                            </div>
