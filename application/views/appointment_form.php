                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open('appointment/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                <label class="col-xs-3 col-form-label" for="patient_name">Patient Name <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="patient_name" autocomplete="off" type="text" class="form-control customerSelection" id="patient_name" placeholder="Patient Name" value="<?php echo $appointment->patient_name ?>" required>
                                    <input id="patient_id" class="customer_hidden_value abc" type="hidden" name="patient_id" value="<?= $appointment->patient_id ?>">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="appointment_type" class="col-xs-3 col-form-label">Ticket Type <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <select name="appointment_type" class="form-control" id="appointment_type" required>
                                        <option value="First"<?= $appointment->appointment_type == 'First' ? ' selected' : '' ?>>First</option>
                                        <option value="Old"<?= $appointment->appointment_type == 'Old' ? ' selected' : '' ?>>Old</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="ticket_fee" class="col-xs-3 col-form-label">Ticket Fee <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="ticket_fee" id="ticket_fee" type="number" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('department_id',$department_list,$appointment->department_id,'class="form-control" id="department_id" required') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('doctor_id','','','class="form-control" id="doctor_id" required') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9"> 
                                    <input name="date" type="text" class="datepicker-avaiable-days form-control" id="date" placeholder="<?php echo display('appointment_date') ?>" required>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            { 
                if (data.status == true) {
                    ...
                    fee = appointment_type.val() == "First" ? data.fee1 : data.fee2;
                    ticket_fee.val(fee);
                } else if (data.status == false) {
                    schedule_id.val('');
