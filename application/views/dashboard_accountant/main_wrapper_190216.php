                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "billing") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/admission/form") ?>"><?php echo display('add_admission') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/admission") ?>"><?php echo display('admission_list') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/advance/form") ?>"><?php echo display('add_advance') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/advance") ?>"><?php echo display('advance_list') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/bill/form") ?>"><?php echo display('add_bill') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/bill") ?>"><?php echo display('bill_list') ?></a></li>  
                            </ul>
                        </li>
