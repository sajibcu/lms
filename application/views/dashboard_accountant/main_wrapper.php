                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        <li class="<?php echo (($this->uri->segment(2) == 'home') ? "active" : null) ?>">
                            <a href="<?php echo base_url('dashboard_accountant/home') ?>"><i class="fa ti-home"></i> <span><?php echo display('dashboard') ?></span></a>
                        </li> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "account_manager" && $this->uri->segment(3) != "report") ? "active" : null) ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li style="display: none"><a href="<?php echo base_url("dashboard_accountant/account_manager/invoice/create") ?>"><?php echo display('add_invoice') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_accountant/account_manager/invoice") ?>"><?php echo display('invoice_list') ?></a></li> 
                                <li><a style="display: none;"> href="<?php echo base_url("dashboard_accountant/account_manager/payment/create") ?>"><?php echo display('add_payment') ?></a></li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "billing") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <!-- <li><a href="<?php echo base_url("dashboard_accountant/billing/service/form") ?>"><?php echo display('add_service') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/service/index") ?>"><?php echo display('service_list') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/package/form") ?>"><?php echo display('add_package') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/package/index") ?>"><?php echo display('package_list') ?></a></li>  -->  
                                <li><a style="display: none;"> href="<?php echo base_url("dashboard_accountant/billing/admission/form") ?>"><?php echo display('add_admission') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/admission") ?>"><?php echo display('admission_list') ?></a></li> 
                                <li><a style="display: none;"> href="<?php echo base_url("dashboard_accountant/billing/advance/form") ?>"><?php echo display('add_advance') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/advance") ?>"><?php echo display('advance_list') ?></a></li>  
                                <li><a style="display: none;"> href="<?php echo base_url("dashboard_accountant/billing/bill/form") ?>"><?php echo display('add_bill') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/billing/bill") ?>">Discharge Bill List</a></li>  
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "account_manager" && $this->uri->segment(3) == "report") ? "active" : null) ?>">
                            ...
                            <!-- <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_accountant/account_manager/report") ?>"><?php echo "Invoice ".display('report') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_accountant/account_manager/report/appointment") ?>">Ticket Report</a></li>
                                <li><a href="<?php echo base_url("dashboard_accountant/account_manager/report/lab") ?>">Lab Report</a></li>
                                ...
                                <li><a href="<?php echo base_url("bed_manager/report") ?>"><?php echo "Bed ".display('report') ?></a></li>
                            </ul> -->
                        ...
                        <?php if(1==2): ?>
                        <li class="treeview <?php echo (($this->uri->segment(2) == "insurance") ? "active" : null) ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_accountant/insurance/insurance/form") ?>"><?php echo display('add_insurance') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/insurance/insurance") ?>"><?php echo display('insurance_list') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_accountant/insurance/limit_approval/form") ?>"><?php echo display('add_limit_approval') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_accountant/insurance/limit_approval") ?>"><?php echo display('limit_approval_list') ?></a></li>  
                            </ul>
                        </li>
                        <?php endif ?>
