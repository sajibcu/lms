<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd billing-panel ">
            ...
            <?php echo form_open('dashboard_accountant/billing/bill/edit/'.$bill->bill_id, array('class'=>'billig-form')) ?>
...
$(document).ready(function(){
    ...
    aid.on('keyup change',function(){
        ...
        $.ajax({
            url: '<?php echo base_url('dashboard_accountant/billing/bill/getInformation') ?>',
            method: 'post',
            dataType: 'json',
            data: {
