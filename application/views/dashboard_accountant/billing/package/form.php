    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_accountant/billing/package/index") ?>"> <i class="fa fa-list"></i>  <?php echo display('package_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php echo form_open('dashboard_accountant/billing/package/form/','class="form-inner"') ?>
                                    ...
                                    <table id="services" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="quantity[]" class="form-control quantity" type="text" placeholder="<?php echo display('quantity') ?>">
                                                </td>
                                                <td>
                                                    <input name="amount[]" class="form-control amount" type="text" placeholder="<?php echo display('amount') ?>">
                                                </td>
                                                <td>
