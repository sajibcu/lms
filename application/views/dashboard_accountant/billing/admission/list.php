        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group" style="display: none;"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_accountant/billing/admission/form") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_admission') ?> </a>  
                </div>
            </div>
                        ...
                        <?php if (!empty($admissions)) { ?>
                            ...
                            <?php foreach ($admissions as $admission) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_accountant/billing/admission/edit/$admission->admission_id") ?>" class="btn btn-xs  btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a style="display: none;"> href="<?php echo base_url("dashboard_accountant/billing/admission/delete/$admission->admission_id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
