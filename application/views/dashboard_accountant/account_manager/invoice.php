    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a style="display: none;"> class="btn btn-success" href="<?php echo base_url("dashboard_accountant/account_manager/invoice/create") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_invoice') ?> </a>  
                </div>
            </div> 
                        ...
                        ?>
                            <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                ...
                                <td class="center">
                                    ...
                                    <a style="display: none;"> href="<?php echo base_url("dashboard_accountant/account_manager/invoice/edit/$value->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                    <a style="display: none;"> href="<?php echo base_url("dashboard_accountant/account_manager/invoice/delete/$value->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                </td>
                            </tr>
                        <?php 
                            $sl++;
