                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('account_manager/payment/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="pay_to"  type="text" class="form-control" id="pay_to" placeholder="Client Name" value="<?php echo $payment->pay_to ?>">
                                </div>
                            </div> 
                           <!--  for Mobile -->
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile"  type="text" class="form-control" id="mobile" placeholder="Mobile" value="<?php echo $payment->mobile ?>" required>
                                </div>
                            </div> 
                            <!--  for Address -->
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="address"  type="text" class="form-control" id="address" placeholder="Address" value="<?php echo $payment->address ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="quantity"  type="text" class="form-control" id="quantity" placeholder="Quantity" value="<?php echo $payment->quantity?>">
                                </div>
                            </div> 
                            <div class="form-group row">
