        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-success" href="#" onclick="UnregisterPatientDetails()"> <i class="fa fa-plus"></i>Unregister patient </a>
                </div>
            </div> 
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        ...
                        <input type="hidden" name="temp_patient" id="temp_patient" value="0">
                                    ...
                                    <th width="40%">
                                        <ul class="list-unstyled"> 
                                            ...
                                            <li><strong><?php echo display('full_name') ?></strong>
                                                <input type="text" class="invoice-input" id="patient_name" name="patient_name">
                                            </li>  
                                            <li> 
                                            <strong><?php echo display('address') ?>&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                <input type="text" class="invoice-input" id="patient_address" name="patient_address">
                                            </li>  
                                        </ul>
                                    </th>  
...
function UnregisterPatientDetails()
{
    $("#temp_patient").val("1");
    var temp_patient_id = <?php echo date('ymd').random_string('numeric', 6);?>;
    //alert(temp_patient_id);
    $("#patient_id").val(temp_patient_id);
