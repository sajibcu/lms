...
$(document).ready(function() {
    ...
    $('#acmReport').DataTable( {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            discount = api.column(7, { page: 'current'} ).data().reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                },0);
            amount = api.column(8, { page: 'current'} ).data().reduce( function (a, b) {
                    return intVal(a) + intVal(b);
                },0); 
            ...
            $( api.column(7).footer()).html(discount.toFixed(2));
            $( api.column(8).footer()).html(amount.toFixed(2));
        } 
    });
});
