    ...
    <div class="col-sm-12">
        <div  class="panel panel-default">
            <div class="panel-body"> 
                ...
                <form class="form-inline" action="<?php echo base_url('account_manager/report/appointment') ?>">
                    ...
                    <div class="form-group hide" id="PatientWise">
                        <label class="sr-only" for="patient_name"><?php echo display('patient_name') ?></label>
                        <input type="text" name="patient_name" class="form-control customerSelection" id="patient_name" placeholder="Patient Name" value="<?php echo $date->patient_name ?>">
                        <input class="baseUrl" type="hidden"  value="<?= base_url() ?>">
                        <input id="SchoolHiddenId" class="customer_hidden_value abc" type="hidden" name="patient_id" value="<?= $date->patient_id ?>">
                    </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            ...
                            <td><?php echo  sprintf('%0.2f', $value->ticket_fee); ?></td>
                        </tr>
                    <?php 
                        $sl++;
