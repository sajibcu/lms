                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('doctor/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                <label for="fee1" class="col-xs-3 col-form-label">Ticket Fee (1<sup>st</sup> Time) <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="fee1" class="form-control" type="number" placeholder="Ticket Fee 1" id="fee1" value="<?php echo $doctor->fee1 ?>" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="fee2" class="col-xs-3 col-form-label">Ticket Fee (2<sup>nd</sup> Time) <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="fee2" class="form-control" type="number" placeholder="Ticket Fee 2" id="fee2" value="<?php echo $doctor->fee2 ?>" required>
                                </div>
                            </div>
