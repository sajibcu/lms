        ...
        <div class="login-wrapper"> 
            ...
            <div class="panel-body copy-dev">
                <div class="col-xs-6 text-left small">
                    Developed by: <a href="http://srs.one" target="_blank" rel="noopener noreferrer">http://srs.one</a>
                </div>
                <div class="col-xs-6 text-right small">
                    Email: <a href="mailto:infosoft.website@gmail.com">help.srstech@gmail.com</a>
                </div>
            </div>
        </div>
        <!-- /.content-wrapper -->
