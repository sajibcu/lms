                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="<?php echo (($this->uri->segment(1) == 'dashboard') ? "active" : null) ?>">
                            <a href="<?php echo base_url('dashboard/home') ?>"><i class="fa fa ti-home"></i> <span><?php echo display('dashboard') ?></span></a>
                        </li> 
                        ...
                        <?php if(false): ?>
                        <li class="treeview <?php echo (($this->uri->segment(1) == "pharmacy_manager") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-flask"></i> <span>Pharmacy Manager</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="treeview <?php echo (($this->uri->segment(2) == "medicine") ? "active" : null) ?>">
                                    <a href="#">
                                        Medicine
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/medicine/category/index') ?>">Medicine Category</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/medicine/type") ?>"> Medicine Type</a></li>
                                        <li><a href="<?php echo base_url('pharmacy_manager/medicine/medicine/index') ?>"><?php echo display('medicine_list') ?></a></li>
                                        <li><a href="<?php echo base_url('pharmacy_manager/medicine/medicine/form') ?>"> <?php echo display('add_medicine') ?></a></li>
                                    </ul>
                                </li>
                                <li class="treeview <?php echo (($this->uri->segment(2) == "manufacturer") ? "active" : null) ?>">
                                    <a href="#">
                                        Manufacturer
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/manufacturer/index') ?>">Manufacturer List</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/manufacturer/form") ?>"> Add Manufacturer</a></li>
                                    </ul>
                                </li>

                                <li class="treeview <?php echo (($this->uri->segment(2) == "purchase") ? "active" : null) ?>">
                                    <a href="#">
                                        Purchase
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/purchase/index') ?>">Manage Purchase</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/purchase/form") ?>"> Add Purchase</a></li>
                                    </ul>
                                </li>

                                <li class="treeview <?php echo (($this->uri->segment(2) == "invoice") ? "active" : null) ?>">
                                    <a href="#">
                                        Invoices
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/invoice/index') ?>">Manage Invoices</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/invoice/form") ?>"> Add Invoice</a></li>
                                    </ul>
                                </li>

                                <li class="treeview <?php echo (($this->uri->segment(2) == "preturn") ? "active" : null) ?>">
                                    <a href="#">
                                        Return
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/preturn/index') ?>">Return</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/preturn/list_invoces") ?>">Stock Return List</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/preturn/list_purchases") ?>">Manufacturer  Return List</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/preturn/list_wastages") ?>">Wastage Return List</a></li>
                                    </ul>
                                </li>

                                <li class="treeview <?php echo (($this->uri->segment(2) == "stock") ? "active" : null) ?>">
                                    <a href="#">
                                        Stock
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('pharmacy_manager/stock/index') ?>">Stock Report</a></li>
                                        <li><a href="<?php echo base_url('pharmacy_manager/stock/out_of_stock') ?>">Out Of Stock</a></li>
                                        <!-- <li><a href="<?php echo base_url("pharmacy_manager/stock/list_manufacturer") ?>">Stock Report (Manufacturer Wise)</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/stock/list_medicines") ?>">Stock Report (Product Wise)</a></li>
                                        <li><a href="<?php echo base_url("pharmacy_manager/stock/list_batches") ?>">Stock Report(Batch Wise)</a></li> -->
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "lab_manager") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-flask"></i> <span>Lab Manager</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="treeview <?php echo (($this->uri->segment(2) == "template") ? "active" : null) ?>">
                                    <a href="#">
                                        Report Templates
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('lab_manager/template/index') ?>"> Template List</a></li>
                                        <li><a href="<?php echo base_url('lab_manager/template/create') ?>"> Create template</a></li>
                                        <li><a href="<?php echo base_url('lab_manager/templates/unit') ?>"> Template Units</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="treeview <?php echo (($this->uri->segment(2) == "invoice") ? "active" : null) ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('lab_manager/invoice/index') ?>">Manage Invoices</a></li>
                                        <li><a href="<?php echo base_url("lab_manager/invoice/form") ?>"> Add Invoice</a></li>
                                    </ul>
                                </li>

                                <li class="treeview <?php echo (($this->uri->segment(2) == "reports") ? "active" : null) ?>">
                                    <a href="#">
                                        Reports
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="<?php echo base_url('lab_manager/reports/index') ?>">Manage Reports</a></li>
                                        <li><a href="<?php echo base_url("lab_manager/reports/requested_reports") ?>"> Requested Reports</a></li>
                                    </ul>
                                </li>

                                <li class="<?php echo (($this->uri->segment(2) == "setting") ? "active" : null) ?>"><a href="<?php echo base_url('lab_manager/setting') ?>">Settings</a></li>
                            </ul>
                        </li>
                        <?php endif ?>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "messages") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-comments-o"></i> <span><?php echo display('messages') ?><?= get_total_unread_messages() ? ' ('.get_total_unread_messages().')' : '' ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a> 
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("messages/message") ?>"> <?php echo display('inbox') ?> <?= get_total_unread_messages() ? ' ('.get_total_unread_messages().')' : '' ?></a></li> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "website") ? "active" : null) ?>">
                            <a href="#">
                                <i class="pe-7s-global"></i> <span>System</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
