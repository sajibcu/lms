                        ...
                        <?php if (!empty($doctors)) { ?>
                            ...
                            <?php foreach ($doctors as $doctor) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        <?php
                                        if($doctor->picture == '' && $doctor->sex == 'Male')
                                        {
                                            echo '<img src="'.base_url().'assets/images/patient/male.png'.'"  width="65" height="50"/>';

                                        }else if($doctor->picture == '' && $doctor->sex == 'Female')
                                        {
                                            echo '<img src="'.base_url().'assets/images/patient/female.png'.'"  width="65" height="50"/>';

                                        }
                                        else{
                                            echo '<img src="'.base_url($doctor->picture).'"  width="65" height="50"/>';
                                        }?>
                                        <!-- <img src="<?php echo base_url($doctor->picture); ?>" alt="" width="65" height="50"/> -->
                                    </td>
