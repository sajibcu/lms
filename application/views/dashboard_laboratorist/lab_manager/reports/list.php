<div class="row">
    <div class="col-sm-12">
        <div class="columns">
            <a href="<?= base_url('dashboard_laboratorist/lab_manager/reports/requested_reports') ?>" class="btn btn-info m-b-5 m-r-2">Requested Reports</a>
        </div>
    </div>
</div>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <?php if( $item->status == 1 || $item->status == 3): ?>
                                            <a href="<?php echo base_url("dashboard_laboratorist/lab_manager/reports/view/$item->id") ?>" class="btn btn-xs  btn-primary"><i class="fa fa-eye"></i></a> 
                                        <?php endif ?>
