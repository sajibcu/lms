                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('setting/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-xs-3 col-form-label"><?php echo display('address') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="website" type="text" class="form-control" id="website" placeholder="Website"  value="<?php echo $setting->website ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile" type="text" class="form-control" id="mobile" placeholder="Mobile"  value="<?php echo $setting->mobile ?>" >
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="fax" class="col-xs-3 col-form-label">Fax No.</label>
                                <div class="col-xs-9">
                                    <input name="fax" type="text" class="form-control" id="fax" placeholder="Fax"  value="<?php echo $setting->fax ?>" >
                                </div>
                            </div>
