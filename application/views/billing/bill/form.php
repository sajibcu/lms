        ...
        <div class="panel panel-bd billing-panel ">
            ...
            <div class="panel-heading no-print row">
                <div class="btn-group col-xs-2"> 
                    <a class="btn btn-primary" href="<?php echo base_url("billing/bill") ?>"> <i class="fa fa-list"></i>  <?php echo display('discharge_bill_list') ?> </a>  
                </div>
                <h2 class="col-xs-10 text-left text-success"><?php echo display('add_discharge_bill') ?></h2>
            </div> 
